    ...
    <div class="item-detail-show">
      <div class="item-detail-left">
        ...
        <div class="item-detail-img-row">
          <div class="item-detail-img-small" v-for="(item, index) in getGoodsDetailBase.goodsImg" :key="index"
  ...
  export default {
    ...
    methods: {
      ...
      addShoppingCartBtn () {
        ...
        console.log(data);
        if (this.userInfo.data === undefined || this.userInfo == {}) {
          this.$Message.error('当前用户未登录');
          this.$router.push({'path': '/login', 'query': {'redirectToShoppingCart': true, 'shoppingCartData': data}});
        } else {
          data.uid = this.userInfo.data.id;
